// src/components/SidePanel/Community/NewCommunityPosts/NewGeneralDiscussionForm.jsx
...
export default function NewGeneralDiscussionForm({
                                                     ...
                                                     onRefresh,  // refetch list after save
                                                 }) {
    /* 1. shared field state */
    const base = useBasePostForm();

    /* 2. extra field – visibility */
    ...
    async function handlePost() {
        ...
        try {
            ...
            form.append('visibility',  visibility);        // ⬅️ NEW
