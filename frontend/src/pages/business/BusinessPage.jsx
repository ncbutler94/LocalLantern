...
export default function BusinessPage() {
    ...
    // fetch current viewer (may be null if logged out)
    ...
    useEffect(() => {
        ...
        fetch('/users/profile', { signal: ac.signal })
            ...
            .then((u) => {
                if (!alive) return;
                // endpoint returns { user: {...} } in our backend; normalize to user object
    ...
    return (
        ...
        >
            {/* Side Panel */}
            <Box
                width={{ xs: '100%', sm: '56%', md: '60%', lg: '66%' }}
                p={2}
                pb={0}
                sx={{
                    overflowY: 'auto',
            ...
            {/* Map Pane */}
            <Box
                width={{ xs: '100%', sm: '44%', md: '40%', lg: '34%' }}
                mt={{ xs: 0, md: 6 }}
                p={2}
                position="relative"
