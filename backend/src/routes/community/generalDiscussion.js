// backend/src/routes/community/generalDiscussion.js
...
const validate = [
    ...
    body('county').trim().notEmpty(),              // county required
...
/* ---------------------------------------------------------------------------
 * GET /api/general-discussion
 *   ?city=&county=   → optional location filters (same algo as L&F)
 * ------------------------------------------------------------------------- */
